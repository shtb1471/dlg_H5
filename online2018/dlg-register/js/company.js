            ...
            success: function (data) {
              console.log(data,'data');
                  if (data.status == 200 && data.body.code == 'SUCCESS') {
                        $("#company").text(data.body.data.name);
                ...
                success:function(result){
                  // console.log(result)
                    if(result.body.code == 'REGISTERED'){
                       ...
                       $.ajax({
                          async:false,
                          url:urlnum+'/auth/ent/register',
                          type:'post',
                          dataType:'json',
                          data:{"phone":phone,"vcode":validma,"pwd":hex_md5("123456"),"clienttype":1,"channel":1,"inviter":inviter,"entname":
