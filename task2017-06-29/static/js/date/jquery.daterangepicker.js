...
(function (factory) {
    ...
    $.fn.dateRangePicker = function (opt) {
        ...
        function init_datepicker() {
            ...
            box.find('.apply-btn-cancel').click(function () {
                closeDatePicker();
            });
        ...
        function createDom() {
            ...
            if (!opt.singleDate) {
                ...
                html += lang('default-default')
            }
            html += '</div>\
					<div class="error-top">error</div>\
					<div class="default-top">default</div>\
					<input type="button" class="apply-btn disabled' + getApplyBtnClass() + '" value="' + lang('apply') + '" />\
					<input type="button" class="apply-btn-cancel" value="' + lang('apply-cancel') + '" />\
				</div>'
        ...
        function createMonthHTML(d) {
            ...
            for (var week = 0; week < 6; week++) {
                ...
                for (var day = 0; day < 7; day++) {
                    ...
                    // console.log(highlightToday,"highlightToday")
                    today.extraClass = '';
                    today.tooltip = '';
                    ...
                    // console.log(todayDivAttr,"todayDivAttr")
